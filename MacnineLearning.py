...
# 訓練誤差の算出
training_error = calc_pred_error(train_X, train_y, model_L, RMSE)
print(training_error) # 0.306...

# テスト誤差の算出
test_error = calc_pred_error(test_X, test_y, model_L, RMSE)
...
# 訓練誤差の算出
training_error = calc_pred_error(train_X, train_y, model_R, RMSE)
print(training_error) # 0.299...

# テスト誤差の算出
test_error = calc_pred_error(test_X, test_y, model_R, RMSE)
...
# 訓練誤差の算出
training_error = calc_pred_error(train_X, train_y, model_D, RMSE)
print(training_error) # 0.034...

# テスト誤差の算出
test_error = calc_pred_error(test_X, test_y, model_D, RMSE)
...
# 訓練誤差の算出
training_error = calc_pred_error(train_X, train_y, model_RF, RMSE)
print(training_error) # 0.134...

# テスト誤差の算出
test_error = calc_pred_error(test_X, test_y, model_RF, RMSE)
...
params = {
    'boosting_type'    : 'gbdt',
    'objective'        : 'regression',  # タスクを回帰問題に設定
    'metric'           : 'rmse',  # RMSE を評価指標に設定
...
# 訓練誤差の算出
training_error = calc_pred_error(train_X, train_y, model_NN, RMSE)
print(training_error) # 0.269...

# テスト誤差の算出
test_error = calc_pred_error(test_X, test_y, model_NN, RMSE)
